              ...
              {cementProducts.map((product, index) => (
                <div key={index} className="product-card-modern">
                  ...
                  <div className="buttons-container">
                    ...
                    <a href="tel:+254788637639" className="btn btn-secondary">Enquire</a>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="bg-primary text-white rounded-lg p-8 text-center">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-xl">+254788637639</p>
              </div>
              <div>
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 mt-6 w-full max-w-xs mx-auto">
                <a href="tel:+254788637639" className="w-full">
                  <Button 
                ...
                <a href="https://wa.me/254788637639" target="_blank" rel="noopener noreferrer" className="w-full">
                  <Button 
                    variant="blue-outline"
                    className="border-white text-white hover:bg-white hover:text-primary w-full"
                  >
